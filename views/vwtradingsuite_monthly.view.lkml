view: vwtradingsuite_monthly {
  ...
  dimension: accountcode {
    ...
    link: {
      ...
      url: "/dashboards/656?Account%20Code={{value}}&Account%20Manager={{ _filters['vwtradingsuite_monthly.accountmanager']}}&Year={{ _filters['vwtradingsuite_monthly.wcmonthdate_year']}}&Month={{ _filters['vwtradingsuite_monthly.wcmonthdate_month_name']}}
             &Week=&Date=&CCG={{ _filters['vwtradingsuite_monthly.ccg']}}&Account%20Service%20Centre={{ _filters['vwtradingsuite_monthly.sc_name']}}&Report%20Group={{ _filters['vwtradingsuite_monthly.reportgroup']}}"
  ...
  dimension: accountmanager {
    ...
    link: {
      ...
      url: "/dashboards/663?Name={{value}}&Year={{ _filters['vwtradingsuite_monthly.wcmonthdate_year']}}&Month={{ _filters['vwtradingsuite_monthly.wcmonthdate_month_name']}}
            &CCG={{ _filters['vwtradingsuite_monthly.ccg']}}&Account%20Service%20Centre={{ _filters['vwtradingsuite_monthly.sc_name']}}&Report%20Group={{ _filters['vwtradingsuite_monthly.reportgroup']}}"
      icon_url: "https://cecil.citysprint.co.uk/favicon.ico"
    }
  ...
  dimension: clientcode {
    ...
    link: {
      ...
      &Week=&CCG={{ _filters['vwtradingsuite_monthly.ccg']}}&Account%20Service%20Centre={{ _filters['vwtradingsuite_monthly.sc_name']}}&Report%20Group={{ _filters['vwtradingsuite_monthly.reportgroup']}}"
      icon_url: "https://cecil.citysprint.co.uk/favicon.ico"
    }
    ...
    link: {
      ...
      &Week=&CCCG={{ _filters['vwtradingsuite_monthly.ccg']}}&Account%20Service%20Centre={{ _filters['vwtradingsuite_monthly.sc_name']}}&Report%20Group={{ _filters['vwtradingsuite_monthly.reportgroup']}}"
      icon_url: "https://cecil.citysprint.co.uk/favicon.ico"
    }
