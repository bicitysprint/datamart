...
set: explore_set {
    ...
    fields:
    [archive,archive_date,archive_month_number,archive_name_of_month,archive_year,jobno,booking_date,booking_month,booking_month_num,booking_month_name,booking_week,booking_week_of_year,booking_year,
    ...
    title,department,sfdivision,user_name,managername,frompostcode,topostcode,fromlatitude,fromlongitude,tolatitude,tolongitude,fromLonglat,toLonglat,pod,acquisitioncode,fromaddress1,toaddress1,
